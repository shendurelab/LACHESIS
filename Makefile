...
pkgdatadir = $(datadir)/lachesis
pkgincludedir = $(includedir)/lachesis
pkglibdir = $(libdir)/lachesis
pkglibexecdir = $(libexecdir)/lachesis
...
ACLOCAL = ${SHELL} /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf/missing autoconf
AUTOHEADER = ${SHELL} /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf/missing autoheader
AUTOMAKE = ${SHELL} /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf/missing automake-1.15
AWK = gawk
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = lachesis version-201701
PACKAGE_TARNAME = lachesis
PACKAGE_URL = 
PACKAGE_VERSION = version-201701
PATH_SEPARATOR = :
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
STRIP = strip
VERSION = version-201701
abs_builddir = /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf
abs_srcdir = /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf
abs_top_builddir = /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf
abs_top_srcdir = /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /cbcb/nelsayed-scratch/atb/git/lachesis/201701_autoconf/install-sh
...
top_builddir = .
top_srcdir = .
SUBDIRS = src/include/samtools src/include/gtools src/include/markov src/include src
all: all-recursive
...
##endif
>>>>>>> 85241b5ce4e272863c80a0134898efc6d0427a9e
